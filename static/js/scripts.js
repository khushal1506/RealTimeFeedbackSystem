...
const inspironLogo = document.querySelector('.inspiron-logo');
...
function load() {
    const darkmode = localStorage.getItem('darkmode') === 'true'; // Fix to check boolean
    if (darkmode) {
...
function setLightMode() {
    ...
    inspironLogo.style.color = "rgb(68, 8, 125)";
    btnIndicator.style.transform = "translateX(0) rotate(0deg)";
}

function setDarkMode() {
    icon.src = moonImage;
    icon.style.filter = "brightness(0.8)";
    inspironLogo.style.color = "gold";
    btnIndicator.style.transform = "translateX(2.5em) rotate(360deg)";
}
...
btn.addEventListener('click', () => {
    ...
    icon.classList.add('animated'); // Add the animation class
    ...
    // Remove animation class after completing rotation
    setTimeout(() => {
